        ...
        <div class="col mb-3">
            <ul class="nav nav-pills" id="myTab" role="tablist">
                ...
                <li class="nav-item ml-auto">
                    <form action="<?= site_url('pengajuan/pendaftar/save_pendaftar/'.$beasiswaid.'/'.$biodata->biodata_id) ?>" role="form" id="formDaftar">
                        <input class="btn btn-primary nav-link" type="button" name="save_pendaftar" value="Daftar Beasiswa" data-toggle="modal" data-target="#submitDaftarModal"/>
                    </form>
                </li>
            </ul>
            <!-- pills content -->
                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <div class="form-group row px-3 py-2">
                                                    <label for="link_google_map" class="col-sm-3 col-form-label">Link Google Map Rumah<span style="color: red;">*</span></label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row px-3 py-2">
                                                    <label for="status_rumah" class="col-sm-3 col-form-label">Status Rumah<span style="color: red;">*</span></label>
                                                    <div class="col-sm-9">
