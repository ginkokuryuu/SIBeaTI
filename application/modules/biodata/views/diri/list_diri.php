		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
                ...
                <div class="col-md-6 mb-3">
                    <a href="<?php echo site_url('biodata/diri') ?>" class="btn btn-primary <?php echo $this->uri->segment(2) == 'diri' ? 'active': '' ?>" role="button">Data Pribadi</a>
                    <a href="<?php echo site_url('biodata/ortu') ?>" class="btn btn-primary <?php echo $this->uri->segment(2) == 'ortu' ? 'active': '' ?>" role="button">Data Orang Tua</a>
                    <a href="<?php echo site_url('biodata/rumah') ?>" class="btn btn-primary <?php echo $this->uri->segment(2) == 'rumah' ? 'active': '' ?>" role="button">Data Tempat Tinggal</a>
                    <a href="<?php echo site_url('biodata/cerita') ?>" class="btn btn-primary <?php echo $this->uri->segment(2) == 'cerita' ? 'active': '' ?>" role="button">Cerita Anda</a>
				</div>
				<!-- DataTables -->
                <!-- Form -->
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <a href="<?php echo site_url('biodata/editdiri/'.$biodata->biodata_id) ?>" class="btn btn-primary" role="button">Edit</a>
                        </form>
                    </div>
                </div>
			<!-- /.container-fluid -->
