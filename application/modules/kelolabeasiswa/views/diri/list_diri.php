...
<head>
    ...
    <div class="container-fluid">
        ...
        <!-- biodata -->
        <div class="col mb-3">
            <a class="btn btn-primary" href="<?php echo site_url('kelolabeasiswa/biodata/index/'.$beasiswa->beasiswa_id) ?>" role="button">Kembali</a>
            <div class="row py-4">
                <!-- pasfoto -->
                <div class="col-4">
                    <form>
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>Rp <?php echo number_format($biodata->penghasilan_ortu) ?? '' ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">UKT</th>
                                                    <td>:</td>
                                                    <td>Rp <?php echo number_format($biodata->ukt) ?? '' ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">IPK</th>
                                                    <td>:</td>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td><?php if ($biodata->beasiswa_lain == "0") { echo "-";} else {echo $biodata->nama_beasiswa;} ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Nilai Beasiswa</th>
                                                            <td>:</td>
                                                            <td>Rp <?php if ($biodata->beasiswa_lain == "0") { echo "0";} else {echo number_format($biodata->nilai_beasiswa);} ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="3" class="cell-breakWord text-justify"><?php if ($biodata->bersedia_kegiatan_alumni == "1") { echo "Ya";} else {echo "Tidak";} ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
